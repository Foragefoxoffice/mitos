...
const FavoriteQuestionCard = ({
  ...
  return (
    <motion.div
      ...
      className={`bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-shadow duration-300 ${isExpanded ? "ring-2 ring-[#35095E]" : ""
        }`}
    >
      <div className="p-6">
        <div className="flex justify-between items-start">
          ...
          <button
            ...
            disabled={isRemoving}
            className={`p-2 rounded-full transition-all duration-200 bg-transparent ${isRemoving ? "opacity-50" : "hover:bg-red-50"
              }`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {["A", "B", "C", "D"].map((option) => (
                  <motion.div
                    ...
                    className={`p-4 rounded-lg border transition-colors ${question.question.correctOption === option
                  ...
                  >
                    <div className="flex items-start">
                      <span
                        className={`inline-flex items-center justify-center w-6 h-6 rounded-full mr-3 flex-shrink-0 ${question.question.correctOption === option
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center">
          ...
          <span
            className={`px-2 py-1 rounded text-xs font-medium ${question.question.correctOption
      ...
      >
        ...
        {pages.map((page) => (
          <button
            ...
            className={`px-4 py-2 border border-gray-300 text-sm font-medium ${currentPage === page
